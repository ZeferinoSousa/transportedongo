...
<a type="button" class="btn btn-success" href="{{route('frota-create')}}">Adicionar Imagens da Frota</a>
<br>
<br>
@if(session('mensagem'))
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('frota-show',$dado->id)}}" class="btn btn-info">Ver</a>
        <a href="{{ route('frota-edit',$dado->id)}}" class="btn btn-warning">Editar</a>
