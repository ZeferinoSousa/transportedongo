...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Editar Imagens da frota</li>
  </ol>
</nav>
...
<div class="container">
  <form action="{{route('frota-update',$frotas->id)}}" method="POST"  enctype="multipart/form-data">
    @csrf
    @method('PUT')
