...
<a type="button" class="btn btn-success" href="{{route('ilha-create')}}">Adicionar Informação da Ilha</a>
<br>
<br>
@if(session('mensagem'))
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('ilha-show',$dado->id)}}" class="btn btn-info">Ver</a>
        <a href="{{ route('ilha-edit',$dado->id)}}" class="btn btn-warning">Editar</a>
