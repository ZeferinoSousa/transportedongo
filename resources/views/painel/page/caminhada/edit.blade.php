...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Editar Caminhada - {{$caminhadas->titulo}}</li>
    </ol>
</nav>
...
<div class="container">
    <form action="{{route('caminhada-update',$caminhadas->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="exampleInputEmail1">Titulo</label>
            <input type="text" name="titulo" class="form-control" id="exampleInputEmail1" value="{{$caminhadas->titulo}}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="descricao" id="summernote" rows="10" required>{{$caminhadas->descricao}}</textarea>
