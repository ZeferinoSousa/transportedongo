...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Adicionar Membro da Equipa</li>
  </ol>
</nav>
...
<div class="container">
    <form action="{{route('team-store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="funcao" class="form-control" id="exampleInputEmail1" required>
