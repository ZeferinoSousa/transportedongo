...
<a type="button" class="btn btn-success" href="{{route('team-create')}}">Adicionar Membro da Equipa</a>
<br>
<br>
@if(session('mensagem'))
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('team-show',$dado->id)}}" class="btn btn-info">Ver</a>
        <a href="{{ route('team-edit',$dado->id)}}" class="btn btn-warning">Editar</a>
