...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Editar Imagem da Galeria</li>
  </ol>
</nav>


<a type="button" class="btn btn-info" href="{{route('galeria-index')}}">Cancelar</a>
<br>
@if($errors->any())
<br>
...
<div class="container">
  <form action="{{route('galeria-update',$galerias->id)}}" method="POST"  enctype="multipart/form-data">
    @csrf
    @method('PUT')
