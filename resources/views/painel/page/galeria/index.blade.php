...
<a type="button" class="btn btn-success" href="{{route('galeria-create')}}">Adicionar Imagens à Galeria</a>
<br>
<br>
@if(session('mensagem'))
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('galeria-show',$dado->id)}}" class="btn btn-info">Ver</a>
        <a href="{{ route('galeria-edit',$dado->id)}}" class="btn btn-warning">Editar</a>
