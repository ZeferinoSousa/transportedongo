...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Adicionar Imagens à slide</li>
  </ol>
</nav>
...
<div class="container">
  <form action="{{route('slide-store')}}" method="POST"  enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" name="slogan" class="form-control" id="exampleFormControlFile1">
    </div>
