...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Editar Imagem de slide</li>
  </ol>
</nav>


<a type="button" class="btn btn-info" href="{{route('slide-index')}}">Cancelar</a>
<br>
@if($errors->any())
<br>
...
<div class="container">
  <form action="{{route('slide-update',$slides->id)}}" method="POST"  enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="exampleFormControlFile1">Slogan</label>
      <input type="text" name="slogan" class="form-control" value="{{$slides->slogan}}" id="exampleFormControlFile1">
    </div>
