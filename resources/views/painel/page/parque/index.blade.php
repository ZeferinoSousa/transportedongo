...
<a type="button" class="btn btn-success" href="{{route('parque-create')}}">Adicionar Parque</a>
<br>
<br>
@if(session('mensagem'))
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('parque-show',$dado->id)}}" class="btn btn-info">Ver</a>
        <a href="{{ route('parque-edit',$dado->id)}}" class="btn btn-warning">Editar</a>
