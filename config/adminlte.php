    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Historia',
                    'url'  => 'admin/historia/index',
                ],
                [
                    'text' => 'Frota',
                    'url'  => 'admin/frota/index',
                ],
                [
                    'text' => 'Equipa',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'A Ilha',
                    'url'  => 'admin/ilha/index',
                ],
                [
                    'text' => 'Parques',
                    'url'  => 'admin/parque/index',
                ],
            ],
        ],
        [
            'text'        => 'Galeria',
            'url'         => 'admin/galeria/index',
            'icon'        => 'fas fa-image',
        ...
        [
            'text'        => 'Infos',
            'url'         => 'admin/info/show/1',
            'icon'        => 'fas fa-info-circle',
            
        ],

        ['header' => 'Defenições de Conta'],
